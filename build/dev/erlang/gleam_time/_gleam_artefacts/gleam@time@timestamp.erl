...
-file("src/gleam/time/timestamp.gleam", 759).
...
-file("src/gleam/time/timestamp.gleam", 837).
?DOC(
...
-file("src/gleam/time/timestamp.gleam", 856).
?DOC(
...
-file("src/gleam/time/timestamp.gleam", 871).
?DOC(
...
-file("src/gleam/time/timestamp.gleam", 885).
?DOC(
...
-file("src/gleam/time/timestamp.gleam", 894).
?DOC(
...
-file("src/gleam/time/timestamp.gleam", 720).
...
-file("src/gleam/time/timestamp.gleam", 659).
...
-file("src/gleam/time/timestamp.gleam", 639).
...
-file("src/gleam/time/timestamp.gleam", 731).
...
-file("src/gleam/time/timestamp.gleam", 570).
-spec parse_year(bitstring()) -> {ok, {integer(), bitstring()}} | {error, nil}.
parse_year(Bytes) ->
    parse_digits(Bytes, 4).

-file("src/gleam/time/timestamp.gleam", 574).
...
-file("src/gleam/time/timestamp.gleam", 582).
...
-file("src/gleam/time/timestamp.gleam", 612).
...
-file("src/gleam/time/timestamp.gleam", 620).
...
-file("src/gleam/time/timestamp.gleam", 628).
...
-file("src/gleam/time/timestamp.gleam", 701).
...
-file("src/gleam/time/timestamp.gleam", 693).
...
-file("src/gleam/time/timestamp.gleam", 766).
...
-file("src/gleam/time/timestamp.gleam", 786).
...
-file("src/gleam/time/timestamp.gleam", 530).
?DOC(
